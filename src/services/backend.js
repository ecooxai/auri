...
export class Backend {
  ...
  async startTerminal(sessionId, cwd, cols, rows, scrollback = null, shellCommand = "") { return this.call("terminal_start", { sessionId, cwd, cols, rows, scrollback, shellCommand }); }
  ...
  async getTerminalCwd(sessionId, logicalCwd) { return this.call("terminal_cwd", { sessionId, logicalCwd }); }
